...
function getEffectiveAiSettings(){const d=loadAiSettings();return d.apiKey?d:{...d,provider:'ollama',apiBase:'http://127.0.0.1:11434',model:d.ollamaModel||'qwen3:1.7b'}}
